...
func NewDatabse(opts NewDatabseOptions) *Database {
	if opts.Log == nil {
		opts.Log = zap.NewNop()
	}
	return &Database{
...
func (d *Database) Connect() error {
	d.log.Info("Connecting to db", zap.String("url", d.createDataSourceName(false)))
	...
	d.log.Debug("Setting conection pool options",
